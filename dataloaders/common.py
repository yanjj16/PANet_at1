...
class PairedDataset(Dataset):
    ...
    """
    def __init__(self, datasets, n_elements, max_iters, test=True,
        ...
        if test:
            if not isinstance(self.n_elements, list):  
                ...
                datasets_indices = [i for i in range(self.n_datasets)]
               
                self.indices = [[(dataset_idx, data_idx) for data_idx in range(self.n_data[dataset_idx])]
